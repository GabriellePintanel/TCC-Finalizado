...
public class ReaderApiTest {
    ...
    @Test
    void getReaderInfo() throws Exception {
        mockMvc
                .perform(MockMvcRequestBuilders.get("/api/reader/tag01"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.jsonPath("$.pilcha").value("bombacha larga"))
